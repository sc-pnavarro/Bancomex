...
| COL001~1.FRM | avi1_Click | CMXsrv_icrd_avi_crd |
| COL001~1.FRM | Avi5_Click | CMXsrv_icrd_dat_liq_ope |
| COL001~1.FRM | form_activate | CMXsrv_fincol_lee_col |
| COL001~1.FRM | Form_Load | CMXsrv_lee_fpro |
| COL001~1.FRM | MCOLCOMI_CLICK | CMXsrv_col_trae_num_ope |
| COL001~1.FRM | MCOLCONTOTOR_CLICK | CMXsrv_fincol_ctb_oto |
| COL001~1.FRM | MCOLELI_CLICK | CMXsrv_fincol_eli_col |
...
| Archivo | Segmento | Procedimiento Almacenado |
|---------|----------|--------------------------|
| Copy of OBL00103.FRM | anunctb_Click | CMXsrv_finobl_calc_anu |
| Copy of OBL00103.FRM | form_activate | CMXsrv_finobl_lee_obl |
| Copy of OBL00103.FRM | Form_Load | CMXsrv_lee_fpro |
| Copy of OBL00103.FRM | Mcbeanl_Click | CMXsrv_finobl_calc_anu |
| Copy of OBL00103.FRM | Mcbectb_Click | CMXsrv_finobl_ctb_oto |
| Copy of OBL00103.FRM | Mcbedel_Click | CMXsrv_fincol_eli_obl |
| Copy of OBL00103.FRM | Mobl_liq_ope_Click | CMXsrv_icrd_dat_liq_ope |
...
| Archivo | Segmento | Procedimiento Almacenado |
|---------|----------|--------------------------|
| Copy of CRD02004.FRM | ACEPTAR_Click | CMXsrv_icrd_act_doc_neg |
| Copy of CRD02004.FRM | Form_Load | CMXsrv_icrd_lee_doc_neg |
| CRD01001.FRM | Form_Activate | CMXsrv_icrd_neg_lee_crd |
